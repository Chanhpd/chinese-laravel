    ...
    <main class="client-main">
        ...
        <div class="mode-buttons-section">
            <div class="mode-buttons-grid">
                ...
                <div class="mode-button" onclick="window.location.href='{{ route('client.hsk.level', ['level' => $level]) }}?saved=1'">
                    <span class="icon">📖</span>
                    <span>Notebook</span>
                </div>
            </div>
        ...
        <div class="pagination-controls">
            ...
            <div class="pagination-nav">
                @if($currentPage > 1)
                <a href="{{ route('client.hsk.level', ['level' => $level, 'page' => $currentPage - 1]) }}" class="page-btn">
                    <svg width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
